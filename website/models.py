...
class JobAssignment(models.Model):
    ...
    job = models.ForeignKey(Job, on_delete=models.CASCADE, db_column='JobID', blank=False)  
    employee = models.ForeignKey(Employee, on_delete=models.CASCADE, db_column='EmployeeID', blank=False)  
    job_role = models.ForeignKey('JobRole', on_delete=models.CASCADE, db_column='JobRoleID', blank=False)  
